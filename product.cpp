...
public:
    ...
    //     return Price;
    // }
    Product(double coin_denominations[6], double quantity_of_coins[6], string cars[5], double quantity[5], double price[5], double need_to_refill[5])
        : Money(coin_denominations, quantity_of_coins)
    { // constructor
        for (int i = 0; i < 5; i++)
        {
