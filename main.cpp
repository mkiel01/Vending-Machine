...
int main()
{
    ...
    VendingMachine machine = VendingMachine(coin_denominations, quantity_of_coins, cars, quantity, price, need_to_refill);

    while (1==1){

    

    machine.save_to_file_product("product.txt");
    machine.read_from_file_product("product.txt");
    cout << "\n";
    cout << "Products:\n";
    cout << "\n";
    machine.print_from_file_product();

    machine.save_to_file_money("money.txt");
    machine.read_from_file_money("money.txt");
    ...
    machine.save_to_file_money_updated("money.txt");
    ...
    machine.save_to_file_product_updated("product.txt");
